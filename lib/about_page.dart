    ...
    return Column(
      children: [
        ...
        _buildInfoCard(
          ...
          content:
              'Horof হলো শিশুদের জন্য তৈরি একটি বিশেষ আরবি বর্ণমালা শিক্ষার অ্যাপ। এই অ্যাপটির মাধ্যমে শিশুরা মজাদার রঙিন কার্ড এবং অডিও উচ্চারণের সাহায্যে সহজেই আরবি হরফগুলো শিখতে পারে। প্রতিটি হরফের সাথে বাংলায় উচ্চারণ দেওয়া আছে, যা বাংলাভাষী শিশুদের শেখাকে আরো সহজ করে তোলে।',
        ),
        ...
        _buildInfoCard(
          ...
          content:
              '📌 সঠিক আরবি উচ্চারণ: প্রতিটি হরফের জন্য আলাদা অডিও রেকর্ডিং রয়েছে যা শিশুদের সঠিক উচ্চারণ শিখতে সাহায্য করে।\n\n'
        ...
        _buildInfoCard(
          ...
          content:
              'এই অ্যাপে মোট ৩০টি আরবি হরফ রয়েছে:\n\n'
        ...
        _buildInfoCard(
          ...
          content:
              'প্রতিটি মুসলিম শিশুর স্বপ্ন হলো কুরআন পড়তে শেখা। কিন্তু আরবি হরফ না জানলে সেই স্বপ্ন পূরণ করা কঠিন। Horof অ্যাপটি তৈরি হয়েছে সেই প্রথম পদক্ষেপটা সহজ করে দেওয়ার জন্য — যাতে শিশুরা খেলার ছলে আরবি হরফ শিখতে পারে এবং কুরআন পড়ার পথে এগিয়ে যেতে পারে।',
        ),
    ...
    return Column(
      children: [
        ...
        _buildInfoCard(
          ...
          title: 'About the App',
          content:
              'Horof is a special Arabic alphabet learning app designed for children. Through this app, children can easily learn Arabic letters using fun, colorful cards and audio pronunciation. Each letter includes its pronunciation in Bengali, making learning even easier for Bengali-speaking children.',
        ),
        const SizedBox(height: 12),
        ...
        _buildInfoCard(
          ...
          title: 'Key Features',
          content:
              '✅ All 30 Arabic letters in one place\n'
        ...
        _buildInfoCard(
          ...
          title: 'Why Use Horof?',
          content:
              '📌 Correct Arabic Pronunciation: Each letter has its own audio recording that helps children learn proper pronunciation.\n\n'
        ...
        _buildInfoCard(
          ...
          content:
              'This app includes all 30 Arabic letters:\n\n'
        ...
        _buildInfoCard(
          ...
          content:
              'Every Muslim child dreams of learning to read the Quran. But without knowing the Arabic alphabet, that dream is hard to fulfill. Horof was created to make that first step easier — so children can learn the Arabic alphabet in a playful way and move forward on the path to reading the Quran.',
        ),
